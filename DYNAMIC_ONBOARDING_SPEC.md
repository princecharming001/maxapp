...
- [ ] **U3 — `onboarding_gap.py` skeleton + Pydantic models + compile_info_schema.**
...
- [ ] **U6 — Deterministic prefill rung in the questioner (NO LLM), behind `slot_prefill_enabled`.**
...
- [ ] **U7 — Extend pending state to a slot queue (backward compatible).**
